...
class Permission_m extends MY_Model {
	...
	public function get_permission($array=NULL, $signal=FALSE) 
	{
	...
	{
		$query = "Select p1.permissionID,p1.name,p1.description, (case when p2.usertype_id = $id then 'yes' else 'no' end) as active From permissions p1 left join permission_relationships p2 ON p1.permissionID = p2.permission_id and p2.usertype_id =$id where p1.active = 'yes'";
		return $this->db->query($query)->result();
	}

	public function get_order_by_permission($array=NULL) 
	{
		$query = parent::get_order_by($array);
		return $query;
	}

	public function insert_permission($array) 
	{
