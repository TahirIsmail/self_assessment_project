        ...
        <div class="card-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_certificate_template')?></li>
                </ol>
            </nav>
        </div><!-- /.card-header -->
            ...
            <div class="row">
                <div class="col-md-10">
                    <form class="row g-3" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 <?=form_error('theme') ? 'has-error' : '';?>">
                            ...
                            <div class="col-md-10">
                                <?=form_dropdown("theme", $buildinThemes, set_value("theme", $certificate_template->theme), "id='theme' class='form-select'");?>
                        ...
                        <div class="mb-3 <?=form_error('main_middle_text') ? 'has-error' : '';?>">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="main_middle_text" name="main_middle_text" rows="2"><?=set_value('main_middle_text', $certificate_template->main_middle_text)?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="top_heading_title" name="top_heading_title" rows="2"><?=set_value('top_heading_title', $certificate_template->top_heading_title)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="top_heading_left" name="top_heading_left" rows="2"><?=set_value('top_heading_left', $certificate_template->top_heading_left)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="top_heading_middle" name="top_heading_middle" rows="2"><?=set_value('top_heading_middle', $certificate_template->top_heading_middle)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="top_heading_right" name="top_heading_right" rows="2"><?=set_value('top_heading_right', $certificate_template->top_heading_right)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 <?=form_error('template') ? 'has-error' : '';?>">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="template" name="template" rows="2"><?=set_value('template', $certificate_template->template)?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="footer_left_text" name="footer_left_text" rows="2"><?=set_value('footer_left_text', $certificate_template->footer_left_text)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="footer_middle_text" name="footer_middle_text" rows="2"><?=set_value('footer_middle_text', $certificate_template->footer_middle_text)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control txtDropTarget" id="footer_right_text" name="footer_right_text" rows="2"><?=set_value('footer_right_text', $certificate_template->footer_right_text)?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="col-md-8">
                                <button type="submit" class="btn btn-success"><?=$this->lang->line("update_certificate_template")?></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="tags" class="form-label"><?=$this->lang->line("certificate_template_tags")?> <?=$this->lang->line('certificate_template_draganddrop')?></label>
                        <div class="col-md-12">
                            <div id="tags">
                                <?=$tag?>
                            </div>
