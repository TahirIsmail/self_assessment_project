    ...
    <div class="card-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('menu_systemadmin')?></li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Name -->
                    <div class="col-md-6">
                        <label for="name" class="form-label"><?=$this->lang->line("systemadmin_name")?> <span class="text-danger">*</span></label>
                        <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : ''?>" id="name" name="name" value="<?=set_value('name', $systemadmin->name)?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('dob') ? 'is-invalid' : ''?>" id="dob" name="dob" value="<?=set_value('dob', date("d-m-Y", strtotime($systemadmin->dob)))?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <?=form_dropdown("sex", array($this->lang->line("systemadmin_sex_male") => $this->lang->line("systemadmin_sex_male"), $this->lang->line("systemadmin_sex_female") => $this->lang->line("systemadmin_sex_female")), set_value("sex", $systemadmin->sex), "id='sex' class='form-select'")?>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('religion') ? 'is-invalid' : ''?>" id="religion" name="religion" value="<?=set_value('religion', $systemadmin->religion)?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control <?=form_error('email') ? 'is-invalid' : ''?>" id="email" name="email" value="<?=set_value('email', $systemadmin->email)?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('phone') ? 'is-invalid' : ''?>" id="phone" name="phone" value="<?=set_value('phone', $systemadmin->phone)?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('address') ? 'is-invalid' : ''?>" id="address" name="address" value="<?=set_value('address', $systemadmin->address)?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('jod') ? 'is-invalid' : ''?>" id="jod" name="jod" value="<?=set_value('jod', date("d-m-Y", strtotime($systemadmin->jod)))?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?=form_error('username') ? 'is-invalid' : ''?>" id="username" name="username" value="<?=set_value('username', $systemadmin->username)?>">
                        <div class="invalid-feedback"><?=form_error('username')?></div>
                    </div>

                    <!-- Submit Button -->
                    <div class="col-12 text-center mt-4">
                        <button type="submit" class="btn btn-success"><?=$this->lang->line("update_systemadmin")?></button>
                    </div>
