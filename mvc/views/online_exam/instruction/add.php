<div class="card">
    <div class="card-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?= $this->lang->line('instruction_add') ?> <?= $this->lang->line('panel_title') ?></li>
            </ol>
        </nav>
    </div><!-- /.card-header -->
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                <form class="g-3" role="form" method="post">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control <?= form_error('content') ? 'is-invalid' : '' ?>" id="content" name="content"><?= set_value('content') ?></textarea>
                        <div class="invalid-feedback">
