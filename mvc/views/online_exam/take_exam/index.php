            ...
            <div class="col-sm-12">
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            <?php if (inicompute($onlineExams)) {
                                $i = 0;
                                foreach ($onlineExams as $onlineExam) {
                                    if ($usertypeID == '3') {
                                        // dd($userSubjectPluck);
                                        if ((($student->classesID == $onlineExam->classID) || ($onlineExam->classID == '0')) && (($student->sectionID == $onlineExam->sectionID) || ($onlineExam->sectionID == '0')) && (($onlineExam->subjectID == '0') || (in_array($onlineExam->subjectID, $userSubjectPluck)))) {
                                            $i++;
