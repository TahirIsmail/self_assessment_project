...
<div class="row">
    ...
    <div class="col-lg-7 col-md-7 col-sm-12 col40">
    <div class="box box-primary borderwhite">
        <div class="box-header with-border">
            <h3 class="box-title">Course Enrollments</h3>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var courseEnrollmentsChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ['Math', 'Science', 'English', 'History'], // Labels for your data
                datasets: [{
                    data: [30, 20, 25, 25], // Corresponding data for each label
                    backgroundColor: [
                        '#ff6384', // Math
                        '#36a2eb', // Science
                        '#cc65fe', // English
            ...
            options: {
                responsive: true,
                cutout: '50%', // Makes it a half-donut
                plugins: {
                    legend: {
                        position: 'top',
                        labels: {
                    ...
                    tooltip: {
                        callbacks: {
                            label: function (context) {
                                ...
                                label += context.raw + '%'; // Display data as percentage
                                return label;
                            }
                        }
                    }
                ...
                animation: {
                    animateRotate: true, // Rotates the chart on load
                    animateScale: true,  // Scales the chart on load
...
<script>
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            cutout: '50%', // Adjust this value to create a donut shape
            rotation: -Math.PI, // Start the rotation at the top (0 degrees)
            circumference: Math.PI, // Show only half the donut
            elements: {
                arc: {
                    borderWidth: 0 // Optional: Removes the border between slices
                }
            }
        }
    });
