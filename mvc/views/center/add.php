    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <label for="section" class="col-sm-2 control-label">
                        <?= $this->lang->line("center_city") ?> <span class="text-red">*</span>
                    </label>
                    <div class="col-sm-6">
            ...
            <div class="form-group">
                <label for="center_date" class="col-sm-2 control-label">
                    <?= $this->lang->line("center_date") ?> <span class="text-red">*</span>
                </label>
                <div class="col-sm-6">
        ...
        <label for="note" class="col-sm-2 control-label">
            <?= $this->lang->line("center_price") ?>
        </label>
        <div class="col-sm-6">
            <input class="form-control" style="resize:none;" id="note" name="note"><?= set_value('note') ?></input>
        </div>
        <span class="col-sm-4 control-label">
