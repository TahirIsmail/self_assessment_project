            ...
            <div class="col-12">
                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class="col-2"><?= $this->lang->line('slno') ?></th>
                                <th class="col-1"><?= $this->lang->line('question_bank_level') ?></th>
                                <th class="col-3"><?= $this->lang->line('question_bank_question') ?></th>
                                <th class="col-1"><?= $this->lang->line('question_bank_group') ?></th>
                                <th class="col-1"><?= $this->lang->line('question_bank_type') ?></th>
                                <?php if (permissionChecker('question_bank_edit') || permissionChecker('question_bank_delete') || permissionChecker('question_bank_view')) { ?>
                                    <th class="col-1"><?= $this->lang->line('action') ?></th>
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (inicompute($question_banks)) {
                                $i = 1;
