...
<body>
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"><i class="fa icon-student"></i> <strong>EDIT STUDENT</strong></h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-5 col-md-offset-1">
                        <div class="form-group <?= form_error('agent_id') ? 'has-error' : '' ?>">
                            ...
                            <input type="text" class="form-control" id="agent_id" name="agent_id" value="<?= set_value('agent_id', $student->agent_id) ?>">
                    ...
                    <div class="col-md-5">
                        <div class="form-group <?= form_error('Fname') ? 'has-error' : '' ?>">
                            ...
                            <input type="text" class="form-control" id="Fname" name="Fname" value="<?= set_value('Fname', $student->Fname) ?>">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1">
                        <div class="form-group <?= form_error('lname') ? 'has-error' : '' ?>">
                            ...
                            <input type="text" class="form-control" id="lname" name="lname" value="<?= set_value('lname', $student->lname) ?>">
                    ...
                    <div class="col-md-5">
                        <div class="form-group <?= form_error('contact') ? 'has-error' : '' ?>">
                            ...
                            <input type="text" class="form-control" id="contact" name="contact" value="<?= set_value('contact', $student->contact) ?>">
                ...
                <div class="form-group">
                    <div class="col-md-10 col-md-offset-1 text-center">
                        <input type="submit" class="btn btn-danger" value="<?= $this->lang->line("edit_student") ?>">
                    </div>
                </div>
            </form>
            <?php if ($siteinfos->note == 1) { ?>
                <div class="callout callout-danger">
                    <p><b>Note:</b> Create teacher, class, section before editing a student.</p>
                </div>
            <?php } ?>
        </div>
    </div>
