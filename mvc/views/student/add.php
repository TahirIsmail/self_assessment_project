                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <div class="form-group <?= form_error('name') ? 'has-error' : '' ?>">
                        <label for="name_id" class="col-sm-2 control-label">
                            <?= $this->lang->line("student_first_name") ?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label for="name_id" class="col-sm-2 control-label">
                            <?= $this->lang->line("student_last_name") ?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name_id" name="last_name" value="<?= set_value('last_name') ?>">
                        </div>
