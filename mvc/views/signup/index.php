        ...
        <form method="post">
            <div class="p-2 row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            <input class="form-control form-control-lg" placeholder="First Name" name="first_name" type="text" value="<?= set_value('first_name') ?>" required>
                        </div>
                        <div class="form-group col-md-6 mb-3">
                            <input class="form-control form-control-lg" placeholder="Last Name" name="last_name" type="text" value="<?= set_value('last_name') ?>">
                        </div>
                    </div>
