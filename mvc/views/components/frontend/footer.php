    ...
    <div class="container">
        <div class="row gx-5">
            <div class="col-lg-4 col-md-6 footer-about">
                <div
                    class="d-flex flex-column h-100 p-4">
                    <a href="index.html" class="navbar-brand mb-5">
                    ...
                    <form action="">
                        <div class="input-group">
                            ...
                            <button class="btn btn-primary m-0">Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mt-4">
                            <a class="btn btn-primary btn-square me-2" href="https://wa.me/yourphonenumber" target="_blank">
        ...
        <div class="row justify-content-end">
            <div class="col-lg-8 col-md-6 mx-auto">
                <div
                    ...
                    <p class="mb-0">
                        &copy;
                        <a class="border-bottom text-white" href="#">The London School Of Educators</a>, All Right Reserved.
